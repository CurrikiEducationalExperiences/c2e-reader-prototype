...
const Navbar = () => {
  return (
    <div className=" w-full bg-white shadow-mainshadow py-[6px] px-6 ">
      <div className="flex items-center justify-between max-w-[1440px] m-auto ">
        ...
        <div className=" flex flex-col items-center cursor-pointer ">
          ...
          <p className=" text-sm leading-5 text-center font-OpenSans font-normal m-0 text-primarycolor ">My Profile</p>
        </div>
      </div>
    </div>
  );
