...
import C2EBuilder from '../../assets/images/c2e-builder.svg';

const Sidebar = ({ Location, open, setOpen }) => {
  return (
    <div
      className={` ${
        open ? 'w-[70px] md:w-[140px]' : 'w-[20px]'
      }  bg-white h-screen z-50 fixed top-0 left-0  py-5 transition ease-in-out delay-150`}
    >
      <div
        onClick={() => {
          setOpen(!open);
        }}
        className="absolute top-[10px] right-[-16px] cursor-pointer w-[30px] h-[30px] bg-white border solid border-[#ccc] rounded-[50%] flex justify-center items-center"
      >
        <img
          ...
          <>
            <Link to="/" className="w-full no-underline hover:underline ">
              ...
              >
                ...
                <h4 className="font-normal text-xs md:text-sm text-[#084892] m-0">
                  Dashboard
                </h4>
              </div>
            </Link>
            <Link to="/my-c2e" className="w-full no-underline hover:underline">
              ...
              >
                ...
                <h4
                  className={`"font-normal text-xs md:text-sm text-[#084892] m-0" 
            ...
            <Link to="/builder" className="w-full no-underline hover:underline">
              <div
                className={`${
              ...
              >
                <img src={C2EBuilder} alt="SideBarIcon" className="w-5 h-5" />
                <h4 className="font-normal text-xs md:text-sm text-[#084892] m-0">
                  C2E Builder
                </h4>
              </div>
