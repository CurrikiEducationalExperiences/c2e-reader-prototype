...
const productCard1 = ({
  ...
  return (
    <div className="relative w-[220px]  lg:w-[239px]">
      ...
      <div className=" pr-4 pl-4 border-[1px] border-solid border-borderColor hover:border-borderGray rounded-[10px] hover:rounded-[10px] hover:bg-blueHighlight hover:shadow-mainshadow  ">
