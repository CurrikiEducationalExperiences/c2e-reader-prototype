...
const ListCard = ({ ProductCardTitle2, ProductCardPrice2, ProductCardDescription2 }) => {
  return (
    <div className="relative">
      ...
      <div className="pt-[24px] pr-4 pl-[89px] w-[976px] border-[1px] border-solid border-borderColor hover:border-borderGray rounded-[10px] hover:rounded-[10px] hover:bg-blueHighlight hover:shadow-mainshadow">
        <div className="mb-2">
          <div className="flex justify-between mb-3 align-baseline">
            <h2 className="font-normal text-sm mb-0 font-OpenSans hover:text-primarycolor2">{ProductCardTitle2}</h2>
