  ...
  return (
    <div className="w-full bg-white h-full calc-function ">
      ...
      <div className="w-full  h-full  px-8 py-7">
        <h4 className="font-medium text-base text-primarycolor2 mb-1">
          License C2E
        </h4>
        <h2 className="font-medium text-2xl text-black mb-2">
          Activity Sampler
        </h2>
            ...
            {({
              ...
              <form onSubmit={handleSubmit} className="flex flex-col ">
                ...
                <div className="mt-7 ml-auto">
                  <button
                    type="submit"
                    className="primary-btn bg-primarycolor text-white save-btn"
    ...
    >
      <Modal.Header closeButton className="">
        <Modal.Title id="contained-modal-title-vcenter">
          <h1 className="font-semibold text-2xl text-primarycolor2 m-0">
            Royalty Information
          </h1>
        </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <div className="grid grid-cols-3 gap-[16px] ">
          <div className="">
            <label className="custom_label mb-3">
